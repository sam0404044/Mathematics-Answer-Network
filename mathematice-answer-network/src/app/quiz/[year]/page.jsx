        ...
        return (
            <div className='page_container'>
                <div
                    className={
                        ' main ' +
                        (this.state.dark_mode ? ' main_dark_mode_on ' : ' main_dark_mode_off ')
                    }
                >
                    <div
                        className={
                            'leave_menu ' +
                            (this.state.exit_menu_status ? 'leave_menu_open' : 'leave_menu_close')
                        }
                    >
                    ...
                    <div className='switch_button_area'>
                        <button
                            className={
                                'switch_button ' + (this.state.index == 0 ? 'edge' : 'notInEdge')
                            }
                        ...
                        <button
                            ...
                            onClick={this.add}
                        >
                            {this.state.index + 1 == this.state.quiz.length ? '提交' : '下一題'}
                        </button>
                    </div>
                    <div
                    ...
                    <div
                        style={{ display: this.state.count_time_or_not ? 'flex' : 'none' }}
                        className='time_area'
                    >
                        {/* 開始時間: */}
